              ...
              if (snapshot.hasData) {
                if (snapshot.data != null) {
                  ...
                  for (var i in snapshot.data.documents) {
                    itemList.add(Item.fromJSON(i.data));
                  }
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Text(itemList[index].name,style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16),),
                                      SizedBox(
                                        height: 15,
                                      ),
                                      Text(
              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      "\$199",
                      style: TextStyle(color: Colors.deepOrangeAccent,fontWeight: FontWeight.w700),
                    )
                  ],
                ),
                Padding(
